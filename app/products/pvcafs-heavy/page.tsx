...
export default function PvcafsHeavyPage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/images/products/flexible-ducts/Pvcafs-HEAVY.webp"
                    alt="PVCAFS-HEAVY"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">PVCAFS-HEAVY</h1>
                <p className="text-xl text-gray-600 mt-6">
                  PVCAFS-HEAVY non-insulated industrial reinforced PVC flexible air ducts are specifically produced for low and medium pressure heating, cooling, ventilation, air conditioning, exhaust and dust extraction systems.
                </p>
              </div>
            </div>
          </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">1 Ply PVC Coated Polyester</td>
                    </tr>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">52-800mm</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Wire Spacing</td>
                      <td className="py-3 px-4">16mm(Ø ≥ 52mm) - 20mm(Ø ≥ 68mm)</td>
                    </tr>
                    <tr className="border-b">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">+3000 Pa (maks)</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Standard Length</td>
                      <td className="py-3 px-4">6M</td>
                    </tr>
                    <tr className="border-b">
            ...
            <TabsContent value="certificates" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse mb-6">
                  <tbody>
                    <tr>
                      <td className="py-3 px-4 font-medium border">AVRUPA (EUROPE)</td>
                      <td className="py-3 px-4 border">95/28/EC</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-medium border">DIN 4102-1 B2 (RAW MATERIAL)</td>
            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <ul className="space-y-2 pl-5 list-disc">
                  <li>PVCAFS-HEAVY non-insulated industrial reinforced PVC flexible air ducts are specifically produced for low and medium pressure heating, cooling, ventilation, air conditioning, exhaust and dust extraction systems.</li>
                  <li>Non-insulated industrial PVCAFS-HEAVY flexible air ducts are airtight.</li>
                  <li>PVCAFS-HEAVY is highly elastic and flexible. It can be easily fitted to circular, oval or rectangular connectors.</li>
                  <li>The dimensions, tolerances and mechanical resistance of PVCAFS-HEAVY are tested, classified & certified according to EN 13180 standard.</li>
                </ul>
