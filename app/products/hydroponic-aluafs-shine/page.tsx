...
export default function HydroponicAluafsShine() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/images/products/flexible-ducts/Hydroponic aluafs shine.webp"
                    alt="HYDROPONIC ALUAFS SHINE"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">HYDROPONIC ALUAFS SHINE</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Reflective aluminum flexible air duct for improved light distribution in hydroponic setups. Designed specifically for hydroponic growing environments with optimal airflow and climate control for enhanced plant growth and productivity.
                </p>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">1 ply Aluminium + 2 ply Polyester (Black)</td>
                    </tr>
