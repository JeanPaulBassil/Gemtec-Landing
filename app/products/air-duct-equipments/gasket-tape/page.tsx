...
export default function GasketTapePage() {
  return (
    <>
      ...
      <section className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <div className="container relative z-10">
          <Link href="/products/air-duct-equipments" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-8 group">
            <ArrowLeft className="w-4 h-4 mr-2 transition-transform group-hover:-translate-x-1" />
            <span>Back to Air Duct Equipments</span>
          </Link>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 transition-transform hover:shadow-xl hover:-translate-y-1 duration-300">
                <div className="relative aspect-square">
                  <Image
                    src="/air duct/Air duct equipments/GASKET TAPE.webp"
                    alt="GASKET TAPE"
                    fill
            ...
            <div className="space-y-8">
              <div>
                ...
                <h1 className="text-4xl font-bold text-gray-800 mb-4 leading-tight">
                  <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">GASKET TAPE</span>
                </h1>
                <div className="w-20 h-1 bg-blue-600 rounded mb-6"></div>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Professional-grade adhesive tape specially designed for creating airtight seals in HVAC duct systems. This high-performance gasket tape ensures reliable connections, prevents air leakage, and helps maintain optimal system efficiency.
                </p>
              </div>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Excellent adhesion and airtight sealing</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 bg-blue-100 rounded-full p-1 text-blue-600">
                      <Check className="w-4 h-4" />
                    </div>
                    <span className="text-gray-700">High-performance with reinforced backing</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 bg-blue-100 rounded-full p-1 text-blue-600">
                      <Check className="w-4 h-4" />
                    </div>
                    <span className="text-gray-700">Long-lasting durability with environmental resistance</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 bg-blue-100 rounded-full p-1 text-blue-600">
                      <Check className="w-4 h-4" />
                    </div>
                    <span className="text-gray-700">Compatible with metal, plastic and other duct materials</span>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-4 font-medium text-blue-800">Type</td>
                      <td className="py-4 px-4">Adhesive Gasket Tape</td>
                    </tr>
                    <tr className="border-b bg-gray-50 hover:bg-gray-100 transition-colors">
                      ...
                      <td className="py-4 px-4">High-performance adhesive with reinforced backing</td>
                    </tr>
                    <tr className="border-b hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-4 font-medium text-blue-800">Application</td>
                      <td className="py-4 px-4">HVAC duct sealing and connection</td>
                    </tr>
                    <tr className="border-b bg-gray-50 hover:bg-gray-100 transition-colors">
                      <td className="py-4 px-4 font-medium text-blue-800">Format</td>
                      <td className="py-4 px-4">Roll format for ease of application</td>
                    </tr>
                    <tr className="border-b hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-4 font-medium text-blue-800">Performance</td>
                      <td className="py-4 px-4">Excellent adhesion and airtight sealing</td>
                    </tr>
                    <tr className="border-b bg-gray-50 hover:bg-gray-100 transition-colors">
                      <td className="py-4 px-4 font-medium text-blue-800">Durability</td>
                      <td className="py-4 px-4">Long-lasting with resistance to environmental factors</td>
                    </tr>
                    <tr className="border-b hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-4 font-medium text-blue-800">Compatibility</td>
                      <td className="py-4 px-4">Works with metal, plastic and other duct materials</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <p className="text-gray-700">Besides, it ensures airtightness against some other factors such as water, dust, smoke, noise, oil, etc.</p>
                  </li>
                </ul>
                
                <div className="mt-8 bg-gray-50 p-6 rounded-lg border border-gray-100">
                  <h3 className="font-medium text-gray-800 mb-3">Standard Sizes:</h3>
                  ...
                  <div className="flex gap-8 mt-3">
                    <div className="bg-white px-4 py-2 rounded-md shadow-sm border border-gray-200">
                      <p className="text-gray-700 font-medium">5 mm x 15 mm</p>
                    </div>
                    <div className="bg-white px-4 py-2 rounded-md shadow-sm border border-gray-200">
                      <p className="text-gray-700 font-medium">5 mm x 25 mm</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl p-10 shadow-xl border border-gray-100 max-w-4xl mx-auto text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Contact our technical team for detailed specifications, customized solutions, and expert advice on implementing GASKET TAPE in your projects.
              </p>
