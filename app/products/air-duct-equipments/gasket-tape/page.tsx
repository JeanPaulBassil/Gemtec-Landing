      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">GASKET TAPE</h1>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">Adhesive Gasket Tape</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Material</td>
                      <td className="py-3 px-4">High-performance adhesive with reinforced backing</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Application</td>
                      <td className="py-3 px-4">HVAC duct sealing and connection</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Format</td>
                      <td className="py-3 px-4">Roll format for ease of application</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Performance</td>
                      <td className="py-3 px-4">Excellent adhesion and airtight sealing</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Durability</td>
                      <td className="py-3 px-4">Long-lasting with resistance to environmental factors</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Compatibility</td>
                      <td className="py-3 px-4">Works with metal, plastic and other duct materials</td>
                    </tr>
                  </tbody>
                </table>
              </div>
