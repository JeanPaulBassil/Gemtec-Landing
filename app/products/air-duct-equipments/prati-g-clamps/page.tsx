...
export default function PratiGClampsPage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/air duct/Air duct equipments/PRATI G CLAMPS.webp"
                    alt="PRATI G CLAMPS"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">PRATI G CLAMPS</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Heavy-duty metal clamps engineered for secure and reliable fastening of duct connections in professional HVAC installations. These high-performance Prati G Clamps provide superior clamping strength and ensure long-lasting, airtight connections in ventilation systems.
                </p>
              </div>
            </div>
          </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">Prati G Metal Duct Clamp</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Material</td>
                      <td className="py-3 px-4">High-grade galvanized steel with protective coating</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Design</td>
                      <td className="py-3 px-4">Engineered for optimal clamping force and stability</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Application</td>
                      <td className="py-3 px-4">Securing duct connections in HVAC systems</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Mechanism</td>
                      <td className="py-3 px-4">Screw-tightening system for adjustable compression</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Compatibility</td>
                      <td className="py-3 px-4">Standard duct sizes and connection points</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Durability</td>
                      <td className="py-3 px-4">Corrosion-resistant with extended service life</td>
                    </tr>
                  </tbody>
                </table>
              </div>
