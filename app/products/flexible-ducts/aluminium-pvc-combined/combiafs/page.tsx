...
export default function CombiafsPage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/air duct/Aluminium & PVC Combined Flexible Air Ducts/COMBIAFS.webp"
                    alt="COMBIAFS"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">COMBIAFS</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Designed for low and medium pressure ventilation and air conditioning systems, COMBIAFS offers a durable non-insulated solution with a black outer face. Perfect for standard commercial and residential applications requiring reliable performance.
                </p>
              </div>
            </div>
          </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-4">Customized lengths, Private labeling, Grey color, White color</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <TabsContent value="certificates" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse mb-6">
                  <tbody>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">İNGİLTERE (UK)</td>
                      <td className="py-3 px-4">BS 476, Part 6&Part 7-Class 0 (Exova)</td>
                    </tr>
                    <tr className="border-b">
                    ...
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">REACH COMPLIANT</td>
                      <td className="py-3 px-4"></td>
                    </tr>
                  </tbody>
                </table>
            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <ul className="space-y-2 pl-5 list-disc">
                  <li>It is a non-insulated aluminum & PVC combined flexible air duct specifically produced for low and medium pressure ventilation and air conditioning systems.</li>
                  <li>It is produced from multi-layer aluminium and polyester, strengthened with high tension hard steel spring wire, covered with a PVC layer.</li>
                  <li>Its dimensions, tolerances and mechanical resistance are tested, classified & certified according to EN 13180 standard.</li>
                  <li>COMBIAFS flexible air ducts are airtight.</li>
