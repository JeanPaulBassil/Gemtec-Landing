...
export default function CombiafsHeavyPage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/air duct/Aluminium & PVC Combined Flexible Air Ducts/COMBIAFS HEAVY.webp"
                    alt="COMBIAFS HEAVY"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">COMBIAFS HEAVY</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Designed for low and medium pressure ventilation and air conditioning systems, COMBIAFS HEAVY offers a durable non-insulated solution with a black outer face. Perfect for commercial and industrial applications requiring reliable performance.
                </p>
              </div>
            </div>
          </div>
            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <ul className="space-y-2 pl-5 list-disc">
                  ...
                  <li>COMBIAFS HEAVY flexible air ducts are airtight.</li>
                  <li>It has high elasticity and flexibility. It can be easily fitted to circular, oval or rectangular connectors.</li>
                  <li>Son derece yüksek esneme, bükülme ve sıkıştırılabilme özelliğine sahiptir. Oval, yuvarlak ve köşe birleştirme yerlerinde montajı kolaydır.</li>
                </ul>
              </div>
            </TabsContent>
          </Tabs>
