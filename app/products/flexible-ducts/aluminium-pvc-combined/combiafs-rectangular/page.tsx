...
export default function CombiafsRectangularPage() {
  return (
    <>
      ...
      <section className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="space-y-8">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 transition-transform hover:shadow-xl hover:-translate-y-1 duration-300">
                <div className="relative aspect-square">
                  <Image
                    src="/air duct/Aluminium & PVC Combined Flexible Air Ducts/COMBIAFS RECTANGULAR.webp"
                    alt="COMBIAFS RECTANGULAR"
                    fill
            ...
            <div className="space-y-8">
              <div>
                <Badge className="mb-4 bg-blue-600 hover:bg-blue-700">Specialized Product</Badge>
                <h1 className="text-4xl font-bold text-gray-800 mb-4 leading-tight">
                  <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">COMBIAFS RECTANGULAR</span>
                </h1>
                <div className="w-20 h-1 bg-blue-600 rounded mb-6"></div>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Rectangular profile combined duct designed for space-efficient installations. Suitable for low and medium pressure ventilation and air conditioning systems where conventional round ducts may not fit.
                </p>
              </div>
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Rectangular in shape for space-efficient installations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 bg-blue-100 rounded-full p-1 text-blue-600">
                      <Check className="w-4 h-4" />
              ...
              <div className="space-y-6">
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <p className="text-gray-700">COMBIAFS RECTANGULAR flexible air ducts are airtight.</p>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="mt-1 bg-blue-100 rounded-full p-1.5 text-blue-600 flex-shrink-0">
                      <Check className="w-4 h-4" />
          ...
          <div className="bg-white rounded-2xl p-10 shadow-xl border border-gray-100 max-w-4xl mx-auto text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Contact our technical team for detailed specifications, customized solutions, and expert advice on implementing COMBIAFS RECTANGULAR in your projects.
              </p>
