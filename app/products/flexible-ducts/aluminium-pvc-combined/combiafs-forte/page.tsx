...
export default function CombiafsFortePage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/air duct/Aluminium & PVC Combined Flexible Air Ducts/COMBIAFS FORTE.webp"
                    alt="COMBIAFS FORTE"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">COMBIAFS FORTE</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Designed for low and medium pressure ventilation and air conditioning systems, COMBIAFS FORTE offers a durable non-insulated solution with a black outer face. Perfect for commercial and industrial applications requiring superior strength and performance.
                </p>
              </div>
            </div>
          </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    ...
                    <tr className="border-b bg-gray-50">
                      ...
                      <td className="py-3 px-4">18 mm (ø ≥ 102 mm)</td>
                    </tr>
                    <tr className="border-b">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-4">Customized lengths, Private labeling Grey color</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <ul className="space-y-2 pl-5 list-disc">
                  ...
                  <li>COMBIAFS FORTE flexible air ducts are airtight.</li>
