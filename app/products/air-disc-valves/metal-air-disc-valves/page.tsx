      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">METAL AIR DISC VALVES</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Professional-grade metal air disc valves engineered for commercial and industrial ventilation applications. These robust valves provide precise airflow control with superior durability and consistent performance in demanding environments.
                </p>
              </div>
            </div>
          </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">Metal Air Disc Valve</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Material</td>
                      <td className="py-3 px-4">Premium galvanized steel with protective coating</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Design</td>
                      <td className="py-3 px-4">Circular design with precision-engineered aperture</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Performance</td>
                      <td className="py-3 px-4">Smooth operation with consistent airflow control</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Application</td>
                      <td className="py-3 px-4">Commercial, industrial, and institutional ventilation systems</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Finish</td>
                      <td className="py-3 px-4">Metallic finish with corrosion resistance</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Mounting</td>
                      <td className="py-3 px-4">Compatible with standard duct connections</td>
                    </tr>
                  </tbody>
                </table>
              </div>
