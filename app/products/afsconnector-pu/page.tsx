...
export default function AfsconnectorPuPage() {
  return (
    <>
      <section className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="relative aspect-square border rounded-lg overflow-hidden bg-white">
            <Image
              src="/images/products/flexible-ducts/AFSCONNECTOR%5BPU%5D.webp"
              alt="AFSCONNECTOR[PU]"
              fill
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-blue-950">AFSCONNECTOR[PU]</h1>
              <div className="mt-6">
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 font-bold">•</span>
                    <span>Flexible duct connector – pu coated fiber glass fabric</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 font-bold">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 font-bold">•</span>
                    <span>High resistance to abrasion</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 font-bold">•</span>
                    <span>Suitable for high temperature applications for a certain period of time (400 <sup>0</sup>C / 2 hours)</span>
                  </li>
                </ul>
              </div>
            </div>
                    ...
                    <table className="w-full border-collapse bg-white rounded-lg overflow-hidden">
                      <tbody>
                        ...
                        <tr className="border-b">
                          ...
                          <td className="py-3 px-4">480 g/m2</td>
                        </tr>
                        <tr className="border-b">
              ...
              <Card className="border-0 shadow-none bg-transparent">
                <CardContent className="pt-0 px-0">
                  <div className="text-gray-700 bg-white p-4 md:p-6 rounded-lg">
                    ...
                    <p className="mb-4">
                      Higher the elasticity, higher the vibration isolation ability for the flexible duct connector. Hence elastomeric materials are used as the flexible connector material. AFSCONNECTOR[PU] is produced using PU coated fiber class.
                    </p>
                    <p className="mb-4">
                      APPLICATION
                    </p>
                    <p className="mb-4">
                      AFSCONNECTOR[PU] is specifically designed for heating, cooling, ventilation and air conditioning systems.
                    </p>
                    <p className="mb-4">
                      AFSCONNECTOR[PU] is used to connect mechanical equipment and rigid air duct or two rigid air ducts, providing dampening against vibration and absorbing lateral movements.
                    </p>
                    <p className="mb-4">
                      GENERAL PROPERTIES
                    </p>
                    <p className="mb-4">
                      AFSCONNECTOR[PU] is leak proof (airtight & waterproof).
                    </p>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                      AFSCONNECTOR[PU] is produced using a special SAFE SEAM technique from galvanized steel plate + coated fabric + galvanized steel plate. The SAFE SEAM clamp system ensures that the coated fabric and the galvanized steel plates are inseparable.
                    </p>
                    <p className="mb-4">
                      SPECIAL SIZE
                    </p>
                    <p>
                      100x120x100 mm AFSCONNECTOR[PU]'s wide galvanized steel plates make it compatible with roll forming and flange manufacture systems.
                    </p>
                  </div>
                </CardContent>
              </Card>
