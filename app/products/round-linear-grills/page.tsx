...
export default function RoundLinearGrillsPage() {
  return (
    <>
      <section className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="relative aspect-square border rounded-lg overflow-hidden bg-white">
            <Image
              src="/images/products/flexible-ducts/ROUND LINEAR GRILLS WITH COLLAR.webp"
              alt="Round Linear Grills with Collar"
              fill
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-blue-950">ROUND LINEAR GRILLS WITH COLLAR</h1>
              <p className="mt-2 text-xl text-gray-600">Round Linear Grills with Collar</p>
            </div>
                      ...
                      <table className="w-full border-collapse">
                        ...
                        <tbody>
                          <tr className="border-b bg-blue-50">
                            <td className="py-3 px-4 font-medium">CONAIR 006 Ölçü</td>
                            <td className="py-3 px-4">126 x Ø103 mm</td>
                          </tr>
                          <tr>
                            <td className="py-3 px-4 font-medium">CONAIR 007 Ölçü</td>
                            <td className="py-3 px-4">239 x Ø199 mm</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
        ...
        <div className="bg-blue-50 rounded-lg p-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              Contact our technical team for detailed specifications and installation guidelines for Round Linear Grills with Collar.
            </p>
