...
export default function AFSTPUFoodgradePage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/images/products/flexible-ducts/AFSTPU(FOODGRADE).webp"
                    alt="AFSTPU(FOODGRADE)"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">AFSTPU(FOODGRADE)</h1>
                <div className="mt-6 space-y-3">
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
                    ...
                    <li>Flexibility</li>
                    <li>Food Grade (only for dry food contact)</li>
                ...
                <div className="mt-6 text-gray-700 italic">
                  <p>Food-grade approved by an independent testing laboratory for the complete hose according to the European Union's EC 1935/2004 and EU 10/2011 directives, the latest EU Directive 2015/174, FDA 21 CFR 177.2600, and microbe resistance. Approval according to EC 1935/2004 and EU 10/2011 (food simulants A, B, D2, E).</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <Tabs defaultValue="technical" className="w-full">
            ...
            <TabsContent value="certificates" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse mb-6">
                  <tbody>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">ULUSLARARASI (GLOBAL)</td>
                      <td className="py-3 px-4">Food grade raw material complies with Commission Regulation EU No 10/2011</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">DIN 4102-1 B1</td>
                      <td className="py-3 px-4"></td>
                    </tr>
                  </tbody>
                </table>
            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <p className="text-gray-700">AFSTPU(FOODGRADE) is produced by %100 thermoplastic polyester polyurethane and reinforced by high tension copper coated steel wire. There are three standard types of thickness for various applications.</p>
                <p className="text-gray-700">AFSTPU(FOODGRADE) is suitable for applications that require high pressure and vacuum resistance. It has leak proof structure and its flexibility is convenient to use in wood industry, metal industry, metal processing, welding extraction, surface cleaning, glass, cement, ceramic, paper and automotive industries.</p>
                <p className="text-gray-700">Due to its high resistance to chemicals, AFSTPU(FOODGRADE) is long lasting solution for industrial applications.</p>
                ...
                <div className="mt-8">
                  ...
                  <p className="font-semibold mb-2">AFSTPU (FOODGRADE)05 & AFSTPU(FOODGRADE)07</p>
                  <ul className="space-y-2 list-disc pl-5">
                  ...
                  <p className="font-semibold mt-4 mb-2">AFSTPU(FOODGRADE)10</p>
                  <ul className="space-y-2 list-disc pl-5">
                    <li className="text-gray-700">30mm ≤ Ø ≤ 76mm, roll</li>
                    <li className="text-gray-700">80mm ≤ Ø ≤ 100mm, folded</li>
                  </ul>
