...
export default function SonoafsNwPage() {
  return (
    <div className="container py-8 md:py-12">
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="relative aspect-square">
          <Image
            src="/images/products/flexible-ducts/Sonoafs-NW.webp"
            alt="SONOAFS-NW"
            fill
        ...
        <div>
          <h1 className="text-3xl font-bold text-blue-600 mb-4">SONOAFS-NW</h1>
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>1 ply Aluminium + 2 ply Polyester</TableCell>
              </TableRow>
              <TableRow>
                <TableHead>Nominal Thickness of Jacket</TableHead>
                <TableCell>45 Micron</TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                ...
                <TableCell>- 20 °C / + 120 °C</TableCell>
              </TableRow>
              <TableRow>
