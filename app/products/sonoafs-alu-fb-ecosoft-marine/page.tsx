...
export default function SonoafsAluFbEcosoftMarinePage() {
  return (
    <>
      <div className="container py-8">
        <div className="grid gap-8 lg:grid-cols-2">
          <Card className="border-0 shadow-none">
            <CardContent className="p-0">
              <div className="relative aspect-square">
                <Image
                  src="/images/products/flexible-ducts/Sonoafs-Alu.fb ecosoft Marine.webp"
                  alt="SONOAFS-ALU.FB ECOSOFT MARINE"
                  fill
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-bold text-blue-950">SONOAFS-ALU.FB ECOSOFT MARINE</h1>
              <ul className="mt-6 space-y-2 text-gray-600">
                <li>Suitable for low and medium pressure ventilation and air conditioning systems,</li>
                <li>Acoustically & thermally insulated,</li>
                ...
                <table className="w-full">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td>3 ply Aluminium + 1 ply Polyester (Perforated)</td>
                    </tr>
                    <tr className="border-b">
                    ...
                    <tr className="border-b">
                      <td className="py-3 font-medium">Barrier Construction</td>
                      <td>1 ply PE (compact)</td>
                    </tr>
                    <tr>
                      <td className="py-3 font-medium">Nominal Thickness of Barrier</td>
                      <td>12 μ</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <Card>
              <CardContent className="p-6">
                <ul className="space-y-3 text-gray-600">
                  <li>It is an acoustically and thermally insulated aluminum flexible air duct specifically produced for low and medium pressure ventilation and air conditioning systems.</li>
                  <li>It is produced from multi-layer aluminium and polyester strengthened with high tension hard steel spring wire, perforated and wrapped by a barrier, surrounded with glass wool insulation and an aluminium vapor barrier.</li>
                  <li>Its dimensions, tolerances and mechanical resistance are tested, classified & certified according to EN 13180 standard.</li>
                  <li>SONOAFS-ALU.FB ECOSOFT MARINE flexible air ducts are airtight.</li>
