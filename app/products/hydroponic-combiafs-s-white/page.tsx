...
export default function HydroponicCombiafsWhitePage() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/images/products/flexible-ducts/Hydroponic combiafs.s white.webp"
                    alt="HYDROPONIC COMBIAFS.S WHITE"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">HYDROPONIC COMBIAFS.S WHITE</h1>
                <p className="text-xl text-gray-600 mt-6">
                  High-performance white flexible air duct for clean room hydroponic applications. Designed specifically for hydroponic growing environments with optimal airflow and climate control for enhanced plant growth and productivity.
                </p>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">1 ply Aluminium + 2 ply Polyester ( Black) + 1 ply PVC ( White)</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Nominal Thickness</td>
                      <td className="py-3 px-4">115 micron</td>
                    </tr>
                    <tr className="border-b">
