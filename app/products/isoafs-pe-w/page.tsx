...
export default function IsoafsPeWPage() {
  return (
    <div className="container py-8 md:py-12">
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="relative aspect-square">
          <Image
            src="/images/products/flexible-ducts/ISOAFS-PE.W.webp"
            alt="ISOAFS PE.W"
            fill
        ...
        <div>
          <h1 className="text-3xl font-bold text-blue-600 mb-4">ISOAFS PE.W</h1>
          <p className="text-gray-600 mb-6">
            ISOAFS PE.W thermally insulated PE flexible air ducts are specifically produced for low and medium pressure heating, cooling, ventilation, exhaust and air conditioning systems.
          </p>
          <p className="text-gray-600 mb-6">
            White thermo bounded polyester fiber insulation and PE vapour barrier.
          </p>
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>Polyester Fiber - 25 mm - 225 kg/m³</TableCell>
              </TableRow>
              <TableRow>
                <TableHead>Diameter Range(Ø)</TableHead>
                <TableCell>82 mm - 800 mm</TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                <TableHead>Nominal Thickness of Barrier</TableHead>
                <TableCell>-</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        ...
        <TabsContent value="features">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p>
                ISOAFS PE.W is highly resilient and can be used in applications with excessive vibration and/or perpetual motion systems.
              </p>
              <p>
                Airtight ISOAFS PE.W is durable, strengthened with high tension steel spring wire, surrounded with white thermos bounded polyester fiber insulation and a PE vapour barrier.
              </p>
              <p>
                ISOAFS PE.W is elastic and flexible. It can be easily fitted to circular, oval or rectangular connectors.
              </p>
            </div>
