...
export default function HydroponicAluafsAntimold() {
  return (
    <>
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="relative aspect-square">
                  <Image
                    src="/images/products/flexible-ducts/Hydroponic aluafs antimold.webp"
                    alt="HYDROPONIC ALUAFS ANTIMOLD"
                    fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">HYDROPONIC ALUAFS ANTIMOLD</h1>
                <p className="text-xl text-gray-600 mt-6">
                  Antimicrobial aluminum flexible air duct for mold prevention in hydroponic environments. Specially designed for the demanding conditions of hydroponic growing systems with enhanced protection against microbiological growth.
                </p>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">3 ply Aluminium + 2 ply Polyester</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Nominal Thickness of Inner Duct</td>
                      <td className="py-3 px-4">70 micron + Hygiene Coating</td>
                    </tr>
                    <tr className="border-b">
            ...
            <TabsContent value="certificates" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse mb-6">
                  <tbody>
                    <tr>
                      <td className="py-3 px-4 font-medium border">(ENGLAND) İNGILTERE</td>
                      <td className="py-3 px-4 border">IMSL</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-medium border">(ITALY) İTALYA</td>
                      <td className="py-3 px-4 border">Eurofins Biolab (Italy)</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 font-medium border">(KOREA) - KORE</td>
                      <td className="py-3 px-4 border">Fiti Testing & Research Institute</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <div className="container">
          <div className="bg-blue-50 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-700 mb-6 max-w-3xl mx-auto">
              Our team of experts is here to help you find the perfect solution for your hydroponic ventilation needs. Feel free to reach out for detailed product information or customized recommendations.
            </p>
