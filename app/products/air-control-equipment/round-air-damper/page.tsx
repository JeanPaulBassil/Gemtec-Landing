      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-blue-600">ROUND AIR DAMPER</h1>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">Durable metal construction</td>
                    </tr>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">HVAC systems, ventilation control</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Function</td>
                      <td className="py-3 px-4">Precise airflow adjustment and regulation</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Installation</td>
                      <td className="py-3 px-4">Easy integration with existing systems</td>
                    </tr>
                  </tbody>
                </table>
              </div>
