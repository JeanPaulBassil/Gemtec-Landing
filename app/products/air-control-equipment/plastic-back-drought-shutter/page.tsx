            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xl text-gray-600 mt-6">
                  Our Plastic Back Drought Shutters are designed to prevent backdraft and maintain proper airflow in ventilation systems. Made from high-quality durable plastic materials, these shutters provide excellent performance and longevity.
                </p>
              </div>
            </div>
          </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">High-quality durable plastic</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-3 px-4 font-medium">Size Range</td>
                      <td className="py-3 px-4">Multiple sizes available</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4 font-medium">Application</td>
                      <td className="py-3 px-4">Ventilation systems, HVAC applications</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">Easy installation with standard connections</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <ul className="space-y-2 pl-5 list-disc">
                  ...
                  <li>Prevents unwanted air backflow</li>
                  <li>Smooth operation with minimal resistance</li>
                  <li>Easy installation and maintenance</li>
                  <li>Available in various sizes to fit different applications</li>
                  <li>Cost-effective solution for ventilation systems</li>
                  <li>Compatible with standard duct systems</li>
                </ul>
              </div>
            </TabsContent>
          </Tabs>
