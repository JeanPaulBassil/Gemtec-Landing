            ...
            <TabsContent value="features" className="bg-white p-6 rounded-lg shadow-sm">
              <div className="space-y-6">
                <ul className="space-y-2 pl-5 list-disc">
                  <li>Premium metal construction for superior durability</li>
                  <li>Enhanced strength for commercial applications</li>
                  <li>Effective backflow prevention system</li>
                  <li>Professional installation options</li>
