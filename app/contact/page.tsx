        ...
        <div className="container max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="space-y-10">
              ...
              <form className="space-y-8 p-8 bg-white rounded-2xl shadow-xl border border-gray-100">
                ...
                <Button className="w-full h-12 text-base bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-md transition-all duration-300 hover:shadow-lg group">
